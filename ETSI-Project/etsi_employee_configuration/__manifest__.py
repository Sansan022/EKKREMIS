{
    'name': 'etsi_employee_configuration',
    'summary': 'employee_inhertance_project',
    'description': 'etsi_project_sky_cable',
    'depends': ['base', 'hr', 'sale_timesheet', 'hr_holidays', 'etsi_hrms'],
    'data':[
